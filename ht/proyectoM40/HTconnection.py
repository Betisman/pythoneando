...
class HtConnManager:	
  ...
  def login(self, username, password, securitycode):
    """
    ...
    try:
      ...
      url = self.recServer + '/common/chppxml.axd?file=login&readonlypassword='+securitycode+'&loginname='+username+'&actionType=login&chppID=3501&chppKey=BE421657-81E6-4AEE-8BF5-CB2E36BB3D6A'

      #construimos el boy de la petición http (para saber qué valores enviar, hemos usado el LiveHttpHeaders de Firefox)
      body = {'actionType':'login','loginname':username, 'readonlypassword':securitycode, 'chppID':'3501', 'chppKey':'BE421657-81E6-4AEE-8BF5-CB2E36BB3D6A'}
